...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class DependencyTypeEntityListing :  IEquatable<DependencyTypeEntityListing>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="obj">Instance of DependencyTypeEntityListing to be compared</param>
        /// <returns>Boolean</returns>
