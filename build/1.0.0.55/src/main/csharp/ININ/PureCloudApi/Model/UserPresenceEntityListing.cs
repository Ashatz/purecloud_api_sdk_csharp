...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class UserPresenceEntityListing :  IEquatable<UserPresenceEntityListing>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserPresenceEntityListing" /> class.
        /// </summary>
        public UserPresenceEntityListing()
        {
        ...
        /// </summary>
        /// <param name="obj">Instance of UserPresenceEntityListing to be compared</param>
        /// <returns>Boolean</returns>
