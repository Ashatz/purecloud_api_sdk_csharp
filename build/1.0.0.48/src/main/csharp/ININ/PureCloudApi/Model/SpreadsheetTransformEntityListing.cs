...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class SpreadsheetTransformEntityListing :  IEquatable<SpreadsheetTransformEntityListing>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="obj">Instance of SpreadsheetTransformEntityListing to be compared</param>
        /// <returns>Boolean</returns>
