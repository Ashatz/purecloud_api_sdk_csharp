...
{
    /// <summary>
    /// ForecastSearchRequest
    /// </summary>
    [DataContract]
    public partial class ForecastSearchRequest :  IEquatable<ForecastSearchRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ForecastSearchRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ForecastSearchRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ForecastSearchRequest" /> class.
        /// </summary>
        ...
        /// <param name="Types">Resource type (required).</param>
        /// <param name="Query">Query.</param>
        public ForecastSearchRequest(SortOrderEnum? SortOrder = null, string SortBy = null, int? PageSize = null, int? PageNumber = null, List<string> ReturnFields = null, List<string> Expand = null, List<string> Types = null, List<ForecastSearchCriteria> Query = null)
        {
            // to ensure "Types" is required (not null)
            if (Types == null)
            {
                throw new InvalidDataException("Types is a required property for ForecastSearchRequest and cannot be null");
            }
            else
            {
                this.Types = Types;
        ...
        public List<ForecastSearchCriteria> Query { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForecastSearchRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ForecastSearchRequest);
        }

        /// <summary>
        /// Returns true if ForecastSearchRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of ForecastSearchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForecastSearchRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
