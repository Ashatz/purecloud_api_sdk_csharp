...
{
    /// <summary>
    /// DocumentDataNotification
    /// </summary>
    [DataContract]
    public partial class DocumentDataNotification :  IEquatable<DocumentDataNotification>
    {
        /// <summary>
        ...
        public DocumentDataNotificationUserData UploadedBy { get; set; }
        /// <summary>
        /// Gets or Sets LockInfo
        /// </summary>
        [DataMember(Name="lockInfo", EmitDefaultValue=false)]
        public DocumentDataNotificationLockInfo LockInfo { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentDataNotification {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DocumentDataNotification);
        }

        /// <summary>
        /// Returns true if DocumentDataNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of DocumentDataNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentDataNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
