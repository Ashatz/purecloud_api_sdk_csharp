...
{
    /// <summary>
    /// RecordingDataNotificationLockInfo
    /// </summary>
    [DataContract]
    public partial class RecordingDataNotificationLockInfo :  IEquatable<RecordingDataNotificationLockInfo>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordingDataNotificationLockInfo {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecordingDataNotificationLockInfo);
        }

        /// <summary>
        /// Returns true if RecordingDataNotificationLockInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of RecordingDataNotificationLockInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecordingDataNotificationLockInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
