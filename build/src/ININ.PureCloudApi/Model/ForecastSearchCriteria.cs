...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForecastSearchCriteria :  IEquatable<ForecastSearchCriteria>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ForecastSearchCriteria" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ForecastSearchCriteria() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ForecastSearchCriteria" /> class.
        /// </summary>
        ...
        public ForecastSearchCriteria(string EndValue = null, List<string> Values = null, string StartValue = null, List<string> Fields = null, string Value = null, OperatorEnum? _Operator = null, List<ForecastSearchCriteria> Group = null, TypeEnum? Type = null)
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for ForecastSearchCriteria and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public List<ForecastSearchCriteria> Group { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForecastSearchCriteria {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ForecastSearchCriteria);
        }

        /// <summary>
        /// Returns true if ForecastSearchCriteria instances are equal
        /// </summary>
        /// <param name="other">Instance of ForecastSearchCriteria to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForecastSearchCriteria other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
