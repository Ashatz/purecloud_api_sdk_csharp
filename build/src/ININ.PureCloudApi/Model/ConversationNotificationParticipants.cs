...
namespace ININ.PureCloudApi.Model
{
    ...
    public partial class ConversationNotificationParticipants :  IEquatable<ConversationNotificationParticipants>
    {
        ...
        /// <param name="Cobrowses">Cobrowses.</param>
        /// <param name="Emails">Emails.</param>
        /// <param name="SocialExpressions">SocialExpressions.</param>
        /// <param name="Videos">Videos.</param>
        /// <param name="AdditionalProperties">AdditionalProperties.</param>
        public ConversationNotificationParticipants(string Id = null, int? ConnectedTime = null, int? EndTime = null, string UserId = null, string ExternalContactId = null, string Name = null, string QueueId = null, string GroupId = null, string Purpose = null, string ConsultParticipantId = null, string Address = null, bool? WrapupRequired = null, bool? WrapupExpected = null, string WrapupPrompt = null, int? WrapupTimeoutMs = null, ConversationNotificationWrapup Wrapup = null, string MonitoredParticipantId = null, Dictionary<string, string> Attributes = null, List<ConversationNotificationCalls> Calls = null, List<ConversationNotificationCallbacks> Callbacks = null, List<ConversationNotificationChats> Chats = null, List<ConversationNotificationCobrowses> Cobrowses = null, List<ConversationNotificationEmails> Emails = null, List<ConversationNotificationSocialExpressions> SocialExpressions = null, List<ConversationNotificationVideos> Videos = null, Object AdditionalProperties = null)
        {
            this.Id = Id;
        ...
        /// <summary>
        /// Gets or Sets Cobrowses
        /// </summary>
        [DataMember(Name="cobrowses", EmitDefaultValue=false)]
        public List<ConversationNotificationCobrowses> Cobrowses { get; set; }
        /// <summary>
        /// Gets or Sets Emails
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Cobrowses: ").Append(Cobrowses).Append("\n");
        ...
        public bool Equals(ConversationNotificationParticipants other)
        {
            ...
            return true &&
                ...
                (
                    this.Cobrowses == other.Cobrowses ||
                    this.Cobrowses != null &&
                    this.Cobrowses.SequenceEqual(other.Cobrowses)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Cobrowses != null)
                    hash = hash * 59 + this.Cobrowses.GetHashCode();
                if (this.Emails != null)
