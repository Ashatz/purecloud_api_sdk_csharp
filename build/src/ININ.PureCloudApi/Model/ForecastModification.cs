...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForecastModification :  IEquatable<ForecastModification>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ForecastModification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ForecastModification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ForecastModification" /> class.
        /// </summary>
        ...
        /// <param name="LastModifiedDate">The last time the modification was changed. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ (required).</param>
        /// <param name="LastModifiedBy">The last user to change the modification (required).</param>
        /// <param name="Notes">Any notes associated with the modification (required).</param>
        public ForecastModification(string Name = null, string ForecastId = null, int? Priority = null, MetricEnum? Metric = null, ModificationTypeEnum? ModificationType = null, double? ModificationValue = null, DateTime? StartDate = null, DateTime? EndDate = null, ForecastFilterAttributes Attributes = null, bool? Enabled = null, DateTime? LastModifiedDate = null, User LastModifiedBy = null, string Notes = null)
        {
            // to ensure "ForecastId" is required (not null)
            if (ForecastId == null)
            {
                throw new InvalidDataException("ForecastId is a required property for ForecastModification and cannot be null");
            }
            else
            {
            ...
            if (Priority == null)
            {
                throw new InvalidDataException("Priority is a required property for ForecastModification and cannot be null");
            }
            else
            {
            ...
            if (Metric == null)
            {
                throw new InvalidDataException("Metric is a required property for ForecastModification and cannot be null");
            }
            else
            {
                this.Metric = Metric;
            ...
            {
                throw new InvalidDataException("ModificationType is a required property for ForecastModification and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ModificationValue is a required property for ForecastModification and cannot be null");
            }
            else
            {
            ...
            if (StartDate == null)
            {
                throw new InvalidDataException("StartDate is a required property for ForecastModification and cannot be null");
            }
            else
            {
            ...
            if (EndDate == null)
            {
                throw new InvalidDataException("EndDate is a required property for ForecastModification and cannot be null");
            }
            else
            {
            ...
            if (Attributes == null)
            {
                throw new InvalidDataException("Attributes is a required property for ForecastModification and cannot be null");
            }
            else
            {
            ...
            if (Enabled == null)
            {
                throw new InvalidDataException("Enabled is a required property for ForecastModification and cannot be null");
            }
            else
            {
                this.Enabled = Enabled;
            }
            // to ensure "LastModifiedDate" is required (not null)
            if (LastModifiedDate == null)
            {
                throw new InvalidDataException("LastModifiedDate is a required property for ForecastModification and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("LastModifiedBy is a required property for ForecastModification and cannot be null");
            }
            else
            {
            ...
            if (Notes == null)
            {
                throw new InvalidDataException("Notes is a required property for ForecastModification and cannot be null");
            }
            else
            {
                this.Notes = Notes;
        ...
        /// </summary>
        /// <value>The last time the modification was changed. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss.SSSZ</value>
        [DataMember(Name="lastModifiedDate", EmitDefaultValue=false)]
        public DateTime? LastModifiedDate { get; set; }
        /// <summary>
        /// The last user to change the modification
        /// </summary>
        /// <value>The last user to change the modification</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForecastModification {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ForecastModification);
        }

        /// <summary>
        /// Returns true if ForecastModification instances are equal
        /// </summary>
        /// <param name="other">Instance of ForecastModification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForecastModification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
