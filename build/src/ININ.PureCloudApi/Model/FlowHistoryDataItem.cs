...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FlowHistoryDataItem :  IEquatable<FlowHistoryDataItem>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowHistoryDataItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FlowHistoryDataItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowHistoryDataItem" /> class.
        /// </summary>
        ...
        public FlowHistoryDataItem(string ParameterName = null, string ParameterType = null, Value ParameterValues = null)
        {
            // to ensure "ParameterName" is required (not null)
            if (ParameterName == null)
            {
                throw new InvalidDataException("ParameterName is a required property for FlowHistoryDataItem and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ParameterType is a required property for FlowHistoryDataItem and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FlowHistoryDataItem);
        }

        /// <summary>
        /// Returns true if FlowHistoryDataItem instances are equal
        /// </summary>
        /// <param name="other">Instance of FlowHistoryDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowHistoryDataItem other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
