...
namespace ININ.PureCloudApi.Model
{
    ...
    public partial class EmailConversationNotificationErrorBody :  IEquatable<EmailConversationNotificationErrorBody>
    {
        ...
        public EmailConversationNotificationErrorBody(int? Status = null, string Code = null, string Message = null, string MessageWithParams = null, Dictionary<string, string> MessageParams = null, string ContextId = null, List<CallbackConversationNotificationErrorInfoDetails> Details = null)
        {
            this.Status = Status;
            this.Code = Code;
