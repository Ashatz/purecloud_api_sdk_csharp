    ...
    public partial class AnalyticsApi : IAnalyticsApi
    {
        ...
        public ApiResponse< string > DeleteReportingScheduleWithHttpInfo (string scheduleId)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling DeleteReportingSchedule: " + localVarResponse.Content, localVarResponse.Content);
        ...
        public ApiResponse< ReportSchedule > GetReportingScheduleWithHttpInfo (string scheduleId)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling GetReportingSchedule: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
        ...
        public ApiResponse< ReportRunEntryEntityDomainListing > GetReportingScheduleHistoryWithHttpInfo (string scheduleId, int? pageNumber = null, int? pageSize = null)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling GetReportingScheduleHistory: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
        ...
        public ApiResponse< ReportRunEntry > GetReportingScheduleHistoryLatestWithHttpInfo (string scheduleId)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling GetReportingScheduleHistoryLatest: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
        ...
        public ApiResponse< ReportRunEntry > GetReportingScheduleHistoryRunIdWithHttpInfo (string runId, string scheduleId)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling GetReportingScheduleHistoryRunId: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
        ...
        public ApiResponse< RunNowResponse > PostReportingScheduleRunreportWithHttpInfo (string scheduleId)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling PostReportingScheduleRunreport: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
        ...
        public ApiResponse< ReportSchedule > PutReportingScheduleWithHttpInfo (string scheduleId, ReportSchedule body)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling PutReportingSchedule: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
