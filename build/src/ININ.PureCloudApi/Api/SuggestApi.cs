...
namespace ININ.PureCloudApi.Api
{
    ...
    public partial class SuggestApi : ISuggestApi
    {
        ...
        public ApiResponse< JsonNodeSearchResponse > GetSuggestWithHttpInfo (string q64, List<string> expand = null, bool? profile = null)
        {
            // verify the required parameter 'q64' is set
            if (q64 == null)
                throw new ApiException(400, "Missing required parameter 'q64' when calling SuggestApi->GetSuggest");
        ...
        public ApiResponse< JsonNodeSearchResponse > PostSuggestWithHttpInfo (SuggestSearchRequest body, bool? profile = null)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling SuggestApi->PostSuggest");
