    ...
    public partial class OAuthApi : IOAuthApi
    {
        ...
        public ApiResponse<Object> DeleteClientWithHttpInfo (string clientId)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling DeleteClient: " + localVarResponse.Content, localVarResponse.Content);
        ...
        public ApiResponse< OAuthClient > GetClientWithHttpInfo (string clientId)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling GetClient: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
        ...
        public ApiResponse<Object> PostClientSecretWithHttpInfo (string clientId)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling PostClientSecret: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
        ...
        public ApiResponse< OAuthClient > PutClientWithHttpInfo (string clientId, OAuthClient body)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling PutClient: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
