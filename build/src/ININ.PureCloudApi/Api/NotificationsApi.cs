    ...
    public partial class NotificationsApi : INotificationsApi
    {
        ...
        public ApiResponse< string > DeleteChannelSubscriptionsWithHttpInfo (string channelId)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling DeleteChannelSubscriptions: " + localVarResponse.Content, localVarResponse.Content);
        ...
        public ApiResponse< ChannelTopicEntityListing > GetChannelSubscriptionsWithHttpInfo (string channelId)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling GetChannelSubscriptions: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
        ...
        public ApiResponse< ChannelTopicEntityListing > PostChannelSubscriptionsWithHttpInfo (string channelId, List<ChannelTopic> body)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling PostChannelSubscriptions: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
        ...
        public ApiResponse< ChannelTopicEntityListing > PutChannelSubscriptionsWithHttpInfo (string channelId, List<ChannelTopic> body)
        {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling PutChannelSubscriptions: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
