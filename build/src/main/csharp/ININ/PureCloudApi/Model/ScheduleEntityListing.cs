...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ScheduleEntityListing :  IEquatable<ScheduleEntityListing>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScheduleEntityListing" /> class.
        /// </summary>
        public ScheduleEntityListing()
        {
        ...
        /// </summary>
        /// <param name="obj">Instance of ScheduleEntityListing to be compared</param>
        /// <returns>Boolean</returns>
