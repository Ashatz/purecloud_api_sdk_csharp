...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class TrunkBase :  IEquatable<TrunkBase>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="obj">Instance of TrunkBase to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TrunkMetabase != null)
                    hash = hash * 57 + this.TrunkMetabase.GetHashCode();
                
                if (this.Properties != null)
                    hash = hash * 57 + this.Properties.GetHashCode();
                
                if (this.TrunkType != null)
                    hash = hash * 57 + this.TrunkType.GetHashCode();
