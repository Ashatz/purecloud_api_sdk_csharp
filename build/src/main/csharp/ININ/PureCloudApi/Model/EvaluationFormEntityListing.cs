...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class EvaluationFormEntityListing :  IEquatable<EvaluationFormEntityListing>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EvaluationFormEntityListing" /> class.
        /// </summary>
        public EvaluationFormEntityListing()
        {
        ...
        /// </summary>
        /// <param name="obj">Instance of EvaluationFormEntityListing to be compared</param>
        /// <returns>Boolean</returns>
