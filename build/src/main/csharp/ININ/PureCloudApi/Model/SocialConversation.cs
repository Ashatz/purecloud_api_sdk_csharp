...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SocialConversation :  IEquatable<SocialConversation>
    { 
        
        /// <summary>
        /// Initializes a new instance of the <see cref="SocialConversation" />class.
        /// </summary>
        ...
        public SocialConversation(string Name = null, List<SocialMediaParticipant> Participants = null, List<string> OtherMediaUris = null, )
        {
            this.Name = Name;
        ...
        public List<SocialMediaParticipant> Participants { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SocialConversation);
        }

        /// <summary>
        /// Returns true if SocialConversation instances are equal
        /// </summary>
        /// <param name="other">Instance of SocialConversation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SocialConversation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
