...
namespace ININ.PureCloudApi.Model
{
    ...
    { 
        ...
        public UserPresenceEntityListing(int? PageSize = null, int? PageNumber = null, long? Total = null, List<UserPresence> Entities = null, string SelfUri = null, string FirstUri = null, string PreviousUri = null, string NextUri = null, string LastUri = null, int? PageCount = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserPresenceEntityListing {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserPresenceEntityListing);
        }

        /// <summary>
        /// Returns true if UserPresenceEntityListing instances are equal
        /// </summary>
        /// <param name="other">Instance of UserPresenceEntityListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserPresenceEntityListing other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
