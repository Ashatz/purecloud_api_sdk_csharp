...
namespace ININ.PureCloudApi.Model
{
    ...
    public partial class FacetFilterItem :  IEquatable<FacetFilterItem>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FacetFilterItem {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FacetFilterItem);
        }

        /// <summary>
        /// Returns true if FacetFilterItem instances are equal
        /// </summary>
        /// <param name="other">Instance of FacetFilterItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FacetFilterItem other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
