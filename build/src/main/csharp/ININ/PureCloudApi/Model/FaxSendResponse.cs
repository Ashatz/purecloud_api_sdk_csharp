...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class FaxSendResponse :  IEquatable<FaxSendResponse>
    {
        /// <summary>
        ...
        public string UploadMethodType { get; set; }
        ...
        /// </summary>
        /// <param name="obj">Instance of FaxSendResponse to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UploadMethodType != null)
                    hash = hash * 57 + this.UploadMethodType.GetHashCode();
