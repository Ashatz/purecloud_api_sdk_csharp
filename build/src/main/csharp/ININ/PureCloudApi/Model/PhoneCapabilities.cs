...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class PhoneCapabilities :  IEquatable<PhoneCapabilities>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="obj">Instance of PhoneCapabilities to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Provisions != null)
                    hash = hash * 57 + this.Provisions.GetHashCode();
                
                if (this.Registers != null)
                    hash = hash * 57 + this.Registers.GetHashCode();
                
                if (this.DualRegisters != null)
                    hash = hash * 57 + this.DualRegisters.GetHashCode();
                
                if (this.HardwareIdType != null)
                    hash = hash * 57 + this.HardwareIdType.GetHashCode();
