...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ExtensionEntityListing :  IEquatable<ExtensionEntityListing>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtensionEntityListing" /> class.
        /// </summary>
        public ExtensionEntityListing()
        {
        ...
        /// </summary>
        /// <param name="obj">Instance of ExtensionEntityListing to be compared</param>
        /// <returns>Boolean</returns>
