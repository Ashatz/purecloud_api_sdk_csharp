...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VideoConversation :  IEquatable<VideoConversation>
    { 
        
        /// <summary>
        /// Initializes a new instance of the <see cref="VideoConversation" />class.
        /// </summary>
        ...
        public List<VideoMediaParticipant> Participants { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VideoConversation {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VideoConversation);
        }

        /// <summary>
        /// Returns true if VideoConversation instances are equal
        /// </summary>
        /// <param name="other">Instance of VideoConversation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VideoConversation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
