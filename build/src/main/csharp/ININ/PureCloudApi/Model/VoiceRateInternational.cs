...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class VoiceRateInternational :  IEquatable<VoiceRateInternational>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VoiceRateInternational" /> class.
        /// </summary>
        public VoiceRateInternational()
        {
        ...
        /// </summary>
        /// <param name="obj">Instance of VoiceRateInternational to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Origin != null)
                    hash = hash * 57 + this.Origin.GetHashCode();
