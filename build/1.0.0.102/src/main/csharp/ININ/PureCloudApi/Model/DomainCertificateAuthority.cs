...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class DomainCertificateAuthority :  IEquatable<DomainCertificateAuthority>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="obj">Instance of DomainCertificateAuthority to be compared</param>
        /// <returns>Boolean</returns>
