...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ExtensionPoolEntityListing :  IEquatable<ExtensionPoolEntityListing>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="obj">Instance of ExtensionPoolEntityListing to be compared</param>
        /// <returns>Boolean</returns>
