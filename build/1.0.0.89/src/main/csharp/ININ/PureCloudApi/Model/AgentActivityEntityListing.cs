...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class AgentActivityEntityListing :  IEquatable<AgentActivityEntityListing>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="obj">Instance of AgentActivityEntityListing to be compared</param>
        /// <returns>Boolean</returns>
