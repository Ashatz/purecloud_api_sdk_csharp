...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class WrapupCodeEntityListing :  IEquatable<WrapupCodeEntityListing>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WrapupCodeEntityListing" /> class.
        /// </summary>
        public WrapupCodeEntityListing()
        {
        ...
        /// </summary>
        /// <param name="obj">Instance of WrapupCodeEntityListing to be compared</param>
        /// <returns>Boolean</returns>
