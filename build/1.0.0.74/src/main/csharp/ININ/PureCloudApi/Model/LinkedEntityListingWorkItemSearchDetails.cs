...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class LinkedEntityListingWorkItemSearchDetails :  IEquatable<LinkedEntityListingWorkItemSearchDetails>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="obj">Instance of LinkedEntityListingWorkItemSearchDetails to be compared</param>
        /// <returns>Boolean</returns>
