...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class VoiceRateInternationalEntityListing :  IEquatable<VoiceRateInternationalEntityListing>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="obj">Instance of VoiceRateInternationalEntityListing to be compared</param>
        /// <returns>Boolean</returns>
