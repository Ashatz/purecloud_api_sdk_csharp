...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class FlowConfigMetaDataEntityListing :  IEquatable<FlowConfigMetaDataEntityListing>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="obj">Instance of FlowConfigMetaDataEntityListing to be compared</param>
        /// <returns>Boolean</returns>
