...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class HardwareRate :  IEquatable<HardwareRate>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as HardwareRate);
        }

        /// <summary>
        /// Returns true if HardwareRate instances are equal
        /// </summary>
        /// <param name="obj">Instance of HardwareRate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HardwareRate other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
