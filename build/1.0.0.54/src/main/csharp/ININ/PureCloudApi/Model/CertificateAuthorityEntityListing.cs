...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class CertificateAuthorityEntityListing :  IEquatable<CertificateAuthorityEntityListing>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="obj">Instance of CertificateAuthorityEntityListing to be compared</param>
        /// <returns>Boolean</returns>
