...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ConversationResponse :  IEquatable<ConversationResponse>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ConversationResponse);
        }

        /// <summary>
        /// Returns true if ConversationResponse instances are equal
        /// </summary>
        /// <param name="obj">Instance of ConversationResponse to be compared</param>
        /// <returns>Boolean</returns>
