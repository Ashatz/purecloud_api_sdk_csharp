...
namespace ININ.PureCloudApi.Api
{
    ...
    public interface IBillingApi
    {
        ...
        /// 
        /// </remarks>
        /// <param name="from">startDateTime</param>
        /// <param name="to">endDateTime</param>
        ...
        /// <param name="effectiveDateStart">Filter voice rates by effective start date.</param>
        /// <param name="effectiveDateEnd">Filter voice rates by effective end date.</param>
