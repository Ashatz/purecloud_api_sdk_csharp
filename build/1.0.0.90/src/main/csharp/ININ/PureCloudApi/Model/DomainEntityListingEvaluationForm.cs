...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class DomainEntityListingEvaluationForm :  IEquatable<DomainEntityListingEvaluationForm>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainEntityListingEvaluationForm" /> class.
        /// </summary>
        public DomainEntityListingEvaluationForm()
        {
        ...
        /// </summary>
        /// <param name="obj">Instance of DomainEntityListingEvaluationForm to be compared</param>
        /// <returns>Boolean</returns>
