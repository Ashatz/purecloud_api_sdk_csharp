...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class UserActionCategoryEntityListing :  IEquatable<UserActionCategoryEntityListing>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserActionCategoryEntityListing" /> class.
        /// </summary>
        public UserActionCategoryEntityListing()
        {
        ...
        /// </summary>
        /// <param name="obj">Instance of UserActionCategoryEntityListing to be compared</param>
        /// <returns>Boolean</returns>
