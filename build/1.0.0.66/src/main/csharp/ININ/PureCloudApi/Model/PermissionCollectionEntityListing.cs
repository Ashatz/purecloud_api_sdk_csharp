...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class PermissionCollectionEntityListing :  IEquatable<PermissionCollectionEntityListing>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="obj">Instance of PermissionCollectionEntityListing to be compared</param>
        /// <returns>Boolean</returns>
