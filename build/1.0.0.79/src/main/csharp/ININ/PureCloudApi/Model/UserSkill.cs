...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class UserSkill :  IEquatable<UserSkill>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="obj">Instance of UserSkill to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Proficiency != null)
                    hash = hash * 57 + this.Proficiency.GetHashCode();
                
                if (this.SkillId != null)
                    hash = hash * 57 + this.SkillId.GetHashCode();
