...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class DocumentEntityListing :  IEquatable<DocumentEntityListing>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentEntityListing" /> class.
        /// </summary>
        public DocumentEntityListing()
        {
        ...
        /// </summary>
        /// <param name="obj">Instance of DocumentEntityListing to be compared</param>
        /// <returns>Boolean</returns>
