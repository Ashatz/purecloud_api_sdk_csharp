...
namespace ININ.PureCloudApi.Api
{
    ...
    public interface IQualityApi
    {
        ...
        /// <param name="startTime">Start time of agent activity</param>
        /// <param name="endTime">End time of agent activity</param>
        ...
        /// <param name="expand">variable name requested by expand list</param>
        /// <param name="conversationId">conversation id</param>
        /// <param name="startTime">Beginning of the calibration query</param>
        /// <param name="endTime">end of the calibration query</param>
        ...
        /// <param name="sortBy">variable name requested to sort by</param>
        /// <param name="expand">variable name requested by expand list</param>
        /// <param name="startTime">The start time specified</param>
        /// <param name="endTime">The end time specified</param>
