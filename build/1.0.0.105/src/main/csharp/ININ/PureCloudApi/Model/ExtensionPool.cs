...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ExtensionPool :  IEquatable<ExtensionPool>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="obj">Instance of ExtensionPool to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StartNumber != null)
                    hash = hash * 57 + this.StartNumber.GetHashCode();
                
                if (this.EndNumber != null)
                    hash = hash * 57 + this.EndNumber.GetHashCode();
