...
namespace ININ.PureCloudApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public class DomainVoiceRateResponseItemEntityListing :  IEquatable<DomainVoiceRateResponseItemEntityListing>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainVoiceRateResponseItemEntityListing" /> class.
        /// </summary>
        public DomainVoiceRateResponseItemEntityListing()
        {
        ...
        /// </summary>
        /// <param name="obj">Instance of DomainVoiceRateResponseItemEntityListing to be compared</param>
        /// <returns>Boolean</returns>
