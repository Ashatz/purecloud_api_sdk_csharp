...
{
    [TestFixture]
    public class SystemPromptAssetEntityListingTests
    {
        private SystemPromptAssetEntityListing instance;
        ...
        public void Init()
        {
            instance = new SystemPromptAssetEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of SystemPromptAssetEntityListing
        /// </summary>
        [Test]
        public void SystemPromptAssetEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<SystemPromptAssetEntityListing> (instance, "instance is a SystemPromptAssetEntityListing");
        }
