...
{
    [TestFixture]
    public class WorkspaceEntityListingTests
    {
        private WorkspaceEntityListing instance;
        ...
        public void Init()
        {
            instance = new WorkspaceEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of WorkspaceEntityListing
        /// </summary>
        [Test]
        public void WorkspaceEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<WorkspaceEntityListing> (instance, "instance is a WorkspaceEntityListing");
        }
