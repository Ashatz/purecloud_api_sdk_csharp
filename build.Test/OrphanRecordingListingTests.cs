...
{
    [TestFixture]
    public class OrphanRecordingListingTests
    {
        private OrphanRecordingListing instance;
        ...
        public void Init()
        {
            instance = new OrphanRecordingListing();
        }
        ...
        /// <summary>
        /// Test an instance of OrphanRecordingListing
        /// </summary>
        [Test]
        public void OrphanRecordingListingInstanceTest()
        {
            Assert.IsInstanceOf<OrphanRecordingListing> (instance, "instance is a OrphanRecordingListing");
        }
