...
{
    [TestFixture]
    public class PhysicalInterfaceEntityListingTests
    {
        private PhysicalInterfaceEntityListing instance;
        ...
        public void Init()
        {
            instance = new PhysicalInterfaceEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of PhysicalInterfaceEntityListing
        /// </summary>
        [Test]
        public void PhysicalInterfaceEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<PhysicalInterfaceEntityListing> (instance, "instance is a PhysicalInterfaceEntityListing");
        }
