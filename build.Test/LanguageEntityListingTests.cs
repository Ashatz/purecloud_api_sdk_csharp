...
{
    [TestFixture]
    public class LanguageEntityListingTests
    {
        private LanguageEntityListing instance;
        ...
        public void Init()
        {
            instance = new LanguageEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of LanguageEntityListing
        /// </summary>
        [Test]
        public void LanguageEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<LanguageEntityListing> (instance, "instance is a LanguageEntityListing");
        }
