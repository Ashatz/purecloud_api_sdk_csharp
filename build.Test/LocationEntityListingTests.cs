...
{
    [TestFixture]
    public class LocationEntityListingTests
    {
        private LocationEntityListing instance;
        ...
        public void Init()
        {
            instance = new LocationEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of LocationEntityListing
        /// </summary>
        [Test]
        public void LocationEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<LocationEntityListing> (instance, "instance is a LocationEntityListing");
        }
