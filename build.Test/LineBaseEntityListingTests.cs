...
{
    [TestFixture]
    public class LineBaseEntityListingTests
    {
        private LineBaseEntityListing instance;
        ...
        public void Init()
        {
            instance = new LineBaseEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of LineBaseEntityListing
        /// </summary>
        [Test]
        public void LineBaseEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<LineBaseEntityListing> (instance, "instance is a LineBaseEntityListing");
        }
