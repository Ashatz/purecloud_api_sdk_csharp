...
{
    [TestFixture]
    public class FlowConfigMetaDataEntityListingTests
    {
        private FlowConfigMetaDataEntityListing instance;
        ...
        public void Init()
        {
            instance = new FlowConfigMetaDataEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of FlowConfigMetaDataEntityListing
        /// </summary>
        [Test]
        public void FlowConfigMetaDataEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<FlowConfigMetaDataEntityListing> (instance, "instance is a FlowConfigMetaDataEntityListing");
        }
