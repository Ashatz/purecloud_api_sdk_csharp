...
{
    [TestFixture]
    public class GroupEntityListingTests
    {
        private GroupEntityListing instance;
        ...
        public void Init()
        {
            instance = new GroupEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of GroupEntityListing
        /// </summary>
        [Test]
        public void GroupEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<GroupEntityListing> (instance, "instance is a GroupEntityListing");
        }
