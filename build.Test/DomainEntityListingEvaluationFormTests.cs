...
{
    [TestFixture]
    public class DomainEntityListingEvaluationFormTests
    {
        private DomainEntityListingEvaluationForm instance;
        ...
        public void Init()
        {
            instance = new DomainEntityListingEvaluationForm();
        }
        ...
        /// <summary>
        /// Test an instance of DomainEntityListingEvaluationForm
        /// </summary>
        [Test]
        public void DomainEntityListingEvaluationFormInstanceTest()
        {
            Assert.IsInstanceOf<DomainEntityListingEvaluationForm> (instance, "instance is a DomainEntityListingEvaluationForm");
        }
