...
{
    [TestFixture]
    public class DIDPoolEntityListingTests
    {
        private DIDPoolEntityListing instance;
        ...
        public void Init()
        {
            instance = new DIDPoolEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of DIDPoolEntityListing
        /// </summary>
        [Test]
        public void DIDPoolEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<DIDPoolEntityListing> (instance, "instance is a DIDPoolEntityListing");
        }
