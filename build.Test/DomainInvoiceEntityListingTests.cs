...
{
    [TestFixture]
    public class DomainInvoiceEntityListingTests
    {
        private DomainInvoiceEntityListing instance;
        ...
        public void Init()
        {
            instance = new DomainInvoiceEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of DomainInvoiceEntityListing
        /// </summary>
        [Test]
        public void DomainInvoiceEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<DomainInvoiceEntityListing> (instance, "instance is a DomainInvoiceEntityListing");
        }
