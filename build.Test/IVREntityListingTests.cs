...
{
    [TestFixture]
    public class IVREntityListingTests
    {
        private IVREntityListing instance;
        ...
        /// <summary>
        /// Test an instance of IVREntityListing
        /// </summary>
        [Test]
        public void IVREntityListingInstanceTest()
        {
            Assert.IsInstanceOf<IVREntityListing> (instance, "instance is a IVREntityListing");
        }
