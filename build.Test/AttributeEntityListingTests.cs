...
{
    [TestFixture]
    public class AttributeEntityListingTests
    {
        private AttributeEntityListing instance;
        ...
        public void Init()
        {
            instance = new AttributeEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of AttributeEntityListing
        /// </summary>
        [Test]
        public void AttributeEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<AttributeEntityListing> (instance, "instance is a AttributeEntityListing");
        }
