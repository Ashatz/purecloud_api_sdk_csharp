...
{
    [TestFixture]
    public class UserPresenceEntityListingTests
    {
        private UserPresenceEntityListing instance;
        ...
        public void Init()
        {
            instance = new UserPresenceEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of UserPresenceEntityListing
        /// </summary>
        [Test]
        public void UserPresenceEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<UserPresenceEntityListing> (instance, "instance is a UserPresenceEntityListing");
        }
