...
{
    [TestFixture]
    public class WorkspaceMemberEntityListingTests
    {
        private WorkspaceMemberEntityListing instance;
        ...
        public void Init()
        {
            instance = new WorkspaceMemberEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of WorkspaceMemberEntityListing
        /// </summary>
        [Test]
        public void WorkspaceMemberEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<WorkspaceMemberEntityListing> (instance, "instance is a WorkspaceMemberEntityListing");
        }
