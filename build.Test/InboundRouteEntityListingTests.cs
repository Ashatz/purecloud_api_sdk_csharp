...
{
    [TestFixture]
    public class InboundRouteEntityListingTests
    {
        private InboundRouteEntityListing instance;
        ...
        public void Init()
        {
            instance = new InboundRouteEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of InboundRouteEntityListing
        /// </summary>
        [Test]
        public void InboundRouteEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<InboundRouteEntityListing> (instance, "instance is a InboundRouteEntityListing");
        }
