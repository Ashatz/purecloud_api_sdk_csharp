...
{
    [TestFixture]
    public class AutomateQueueMemberEntityListingTests
    {
        private AutomateQueueMemberEntityListing instance;
        ...
        public void Init()
        {
            instance = new AutomateQueueMemberEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of AutomateQueueMemberEntityListing
        /// </summary>
        [Test]
        public void AutomateQueueMemberEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<AutomateQueueMemberEntityListing> (instance, "instance is a AutomateQueueMemberEntityListing");
        }
