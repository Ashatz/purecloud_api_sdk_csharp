...
{
    [TestFixture]
    public class ConversationEntityListingTests
    {
        private ConversationEntityListing instance;
        ...
        public void Init()
        {
            instance = new ConversationEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of ConversationEntityListing
        /// </summary>
        [Test]
        public void ConversationEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<ConversationEntityListing> (instance, "instance is a ConversationEntityListing");
        }
