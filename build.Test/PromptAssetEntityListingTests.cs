...
{
    [TestFixture]
    public class PromptAssetEntityListingTests
    {
        private PromptAssetEntityListing instance;
        ...
        public void Init()
        {
            instance = new PromptAssetEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of PromptAssetEntityListing
        /// </summary>
        [Test]
        public void PromptAssetEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<PromptAssetEntityListing> (instance, "instance is a PromptAssetEntityListing");
        }
