...
{
    [TestFixture]
    public class QueuesEntityListingTests
    {
        private QueuesEntityListing instance;
        ...
        public void Init()
        {
            instance = new QueuesEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of QueuesEntityListing
        /// </summary>
        [Test]
        public void QueuesEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<QueuesEntityListing> (instance, "instance is a QueuesEntityListing");
        }
