...
{
    [TestFixture]
    public class PhoneBaseEntityListingTests
    {
        private PhoneBaseEntityListing instance;
        ...
        public void Init()
        {
            instance = new PhoneBaseEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of PhoneBaseEntityListing
        /// </summary>
        [Test]
        public void PhoneBaseEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<PhoneBaseEntityListing> (instance, "instance is a PhoneBaseEntityListing");
        }
