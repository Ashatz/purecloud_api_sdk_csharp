...
{
    [TestFixture]
    public class SystemPromptAssetTests
    {
        private SystemPromptAsset instance;
        ...
        public void Init()
        {
            instance = new SystemPromptAsset();
        }
        ...
        /// <summary>
        /// Test an instance of SystemPromptAsset
        /// </summary>
        [Test]
        public void SystemPromptAssetInstanceTest()
        {
            Assert.IsInstanceOf<SystemPromptAsset> (instance, "instance is a SystemPromptAsset");
        }
