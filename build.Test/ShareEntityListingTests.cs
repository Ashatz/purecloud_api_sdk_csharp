...
{
    [TestFixture]
    public class ShareEntityListingTests
    {
        private ShareEntityListing instance;
        ...
        public void Init()
        {
            instance = new ShareEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of ShareEntityListing
        /// </summary>
        [Test]
        public void ShareEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<ShareEntityListing> (instance, "instance is a ShareEntityListing");
        }
