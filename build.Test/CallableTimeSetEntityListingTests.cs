...
{
    [TestFixture]
    public class CallableTimeSetEntityListingTests
    {
        private CallableTimeSetEntityListing instance;
        ...
        public void Init()
        {
            instance = new CallableTimeSetEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of CallableTimeSetEntityListing
        /// </summary>
        [Test]
        public void CallableTimeSetEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<CallableTimeSetEntityListing> (instance, "instance is a CallableTimeSetEntityListing");
        }
