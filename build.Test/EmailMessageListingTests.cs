...
{
    [TestFixture]
    public class EmailMessageListingTests
    {
        private EmailMessageListing instance;
        ...
        public void Init()
        {
            instance = new EmailMessageListing();
        }
        ...
        /// <summary>
        /// Test an instance of EmailMessageListing
        /// </summary>
        [Test]
        public void EmailMessageListingInstanceTest()
        {
            Assert.IsInstanceOf<EmailMessageListing> (instance, "instance is a EmailMessageListing");
        }
