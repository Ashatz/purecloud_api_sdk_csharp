...
{
    [TestFixture]
    public class QueueMemberEntityListingTests
    {
        private QueueMemberEntityListing instance;
        ...
        public void Init()
        {
            instance = new QueueMemberEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of QueueMemberEntityListing
        /// </summary>
        [Test]
        public void QueueMemberEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<QueueMemberEntityListing> (instance, "instance is a QueueMemberEntityListing");
        }
