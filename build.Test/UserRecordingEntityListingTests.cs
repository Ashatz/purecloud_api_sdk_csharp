...
{
    [TestFixture]
    public class UserRecordingEntityListingTests
    {
        private UserRecordingEntityListing instance;
        ...
        public void Init()
        {
            instance = new UserRecordingEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of UserRecordingEntityListing
        /// </summary>
        [Test]
        public void UserRecordingEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<UserRecordingEntityListing> (instance, "instance is a UserRecordingEntityListing");
        }
