...
{
    [TestFixture]
    public class CampaignSequenceEntityListingTests
    {
        private CampaignSequenceEntityListing instance;
        ...
        public void Init()
        {
            instance = new CampaignSequenceEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of CampaignSequenceEntityListing
        /// </summary>
        [Test]
        public void CampaignSequenceEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<CampaignSequenceEntityListing> (instance, "instance is a CampaignSequenceEntityListing");
        }
