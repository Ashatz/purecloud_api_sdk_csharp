...
{
    [TestFixture]
    public class LineEntityListingTests
    {
        private LineEntityListing instance;
        ...
        public void Init()
        {
            instance = new LineEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of LineEntityListing
        /// </summary>
        [Test]
        public void LineEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<LineEntityListing> (instance, "instance is a LineEntityListing");
        }
