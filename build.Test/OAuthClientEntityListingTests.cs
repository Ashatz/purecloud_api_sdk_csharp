...
{
    [TestFixture]
    public class OAuthClientEntityListingTests
    {
        private OAuthClientEntityListing instance;
        ...
        public void Init()
        {
            instance = new OAuthClientEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of OAuthClientEntityListing
        /// </summary>
        [Test]
        public void OAuthClientEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<OAuthClientEntityListing> (instance, "instance is a OAuthClientEntityListing");
        }
