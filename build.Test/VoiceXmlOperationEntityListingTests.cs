...
{
    [TestFixture]
    public class VoiceXmlOperationEntityListingTests
    {
        private VoiceXmlOperationEntityListing instance;
        ...
        public void Init()
        {
            instance = new VoiceXmlOperationEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of VoiceXmlOperationEntityListing
        /// </summary>
        [Test]
        public void VoiceXmlOperationEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<VoiceXmlOperationEntityListing> (instance, "instance is a VoiceXmlOperationEntityListing");
        }
