...
{
    [TestFixture]
    public class TrunkMetabaseEntityListingTests
    {
        private TrunkMetabaseEntityListing instance;
        ...
        public void Init()
        {
            instance = new TrunkMetabaseEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of TrunkMetabaseEntityListing
        /// </summary>
        [Test]
        public void TrunkMetabaseEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<TrunkMetabaseEntityListing> (instance, "instance is a TrunkMetabaseEntityListing");
        }
