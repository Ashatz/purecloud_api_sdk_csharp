...
{
    [TestFixture]
    public class FlowEntityListingTests
    {
        private FlowEntityListing instance;
        ...
        public void Init()
        {
            instance = new FlowEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of FlowEntityListing
        /// </summary>
        [Test]
        public void FlowEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<FlowEntityListing> (instance, "instance is a FlowEntityListing");
        }
