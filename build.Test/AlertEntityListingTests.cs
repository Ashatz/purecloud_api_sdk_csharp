...
{
    [TestFixture]
    public class AlertEntityListingTests
    {
        private AlertEntityListing instance;
        ...
        public void Init()
        {
            instance = new AlertEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of AlertEntityListing
        /// </summary>
        [Test]
        public void AlertEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<AlertEntityListing> (instance, "instance is a AlertEntityListing");
        }
