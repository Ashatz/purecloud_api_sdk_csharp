...
{
    [TestFixture]
    public class ExternalOrganizationListingTests
    {
        private ExternalOrganizationListing instance;
        ...
        public void Init()
        {
            instance = new ExternalOrganizationListing();
        }
        ...
        /// <summary>
        /// Test an instance of ExternalOrganizationListing
        /// </summary>
        [Test]
        public void ExternalOrganizationListingInstanceTest()
        {
            Assert.IsInstanceOf<ExternalOrganizationListing> (instance, "instance is a ExternalOrganizationListing");
        }
