...
{
    [TestFixture]
    public class DomainThirdPartySubscriptionEntityListingTests
    {
        private DomainThirdPartySubscriptionEntityListing instance;
        ...
        public void Init()
        {
            instance = new DomainThirdPartySubscriptionEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of DomainThirdPartySubscriptionEntityListing
        /// </summary>
        [Test]
        public void DomainThirdPartySubscriptionEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<DomainThirdPartySubscriptionEntityListing> (instance, "instance is a DomainThirdPartySubscriptionEntityListing");
        }
