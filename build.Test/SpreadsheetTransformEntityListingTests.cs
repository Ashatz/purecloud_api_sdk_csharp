...
{
    [TestFixture]
    public class SpreadsheetTransformEntityListingTests
    {
        private SpreadsheetTransformEntityListing instance;
        ...
        public void Init()
        {
            instance = new SpreadsheetTransformEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of SpreadsheetTransformEntityListing
        /// </summary>
        [Test]
        public void SpreadsheetTransformEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<SpreadsheetTransformEntityListing> (instance, "instance is a SpreadsheetTransformEntityListing");
        }
