...
{
    [TestFixture]
    public class QuoteListingTests
    {
        private QuoteListing instance;
        ...
        /// <summary>
        /// Test an instance of QuoteListing
        /// </summary>
        [Test]
        public void QuoteListingInstanceTest()
        {
            Assert.IsInstanceOf<QuoteListing> (instance, "instance is a QuoteListing");
        }
