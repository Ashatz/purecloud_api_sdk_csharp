...
{
    [TestFixture]
    public class FaxDocumentEntityListingTests
    {
        private FaxDocumentEntityListing instance;
        ...
        public void Init()
        {
            instance = new FaxDocumentEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of FaxDocumentEntityListing
        /// </summary>
        [Test]
        public void FaxDocumentEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<FaxDocumentEntityListing> (instance, "instance is a FaxDocumentEntityListing");
        }
