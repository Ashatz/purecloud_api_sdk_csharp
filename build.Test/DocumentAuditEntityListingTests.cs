...
{
    [TestFixture]
    public class DocumentAuditEntityListingTests
    {
        private DocumentAuditEntityListing instance;
        ...
        public void Init()
        {
            instance = new DocumentAuditEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of DocumentAuditEntityListing
        /// </summary>
        [Test]
        public void DocumentAuditEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<DocumentAuditEntityListing> (instance, "instance is a DocumentAuditEntityListing");
        }
