...
{
    [TestFixture]
    public class CampaignEntityListingTests
    {
        private CampaignEntityListing instance;
        ...
        public void Init()
        {
            instance = new CampaignEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of CampaignEntityListing
        /// </summary>
        [Test]
        public void CampaignEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<CampaignEntityListing> (instance, "instance is a CampaignEntityListing");
        }
