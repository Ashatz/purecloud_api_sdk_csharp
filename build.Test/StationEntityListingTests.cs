...
{
    [TestFixture]
    public class StationEntityListingTests
    {
        private StationEntityListing instance;
        ...
        public void Init()
        {
            instance = new StationEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of StationEntityListing
        /// </summary>
        [Test]
        public void StationEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<StationEntityListing> (instance, "instance is a StationEntityListing");
        }
