...
{
    [TestFixture]
    public class ReportMetaDataEntityListingTests
    {
        private ReportMetaDataEntityListing instance;
        ...
        public void Init()
        {
            instance = new ReportMetaDataEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of ReportMetaDataEntityListing
        /// </summary>
        [Test]
        public void ReportMetaDataEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<ReportMetaDataEntityListing> (instance, "instance is a ReportMetaDataEntityListing");
        }
