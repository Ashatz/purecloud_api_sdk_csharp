...
{
    [TestFixture]
    public class TopicEntityListingTests
    {
        private TopicEntityListing instance;
        ...
        public void Init()
        {
            instance = new TopicEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of TopicEntityListing
        /// </summary>
        [Test]
        public void TopicEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<TopicEntityListing> (instance, "instance is a TopicEntityListing");
        }
