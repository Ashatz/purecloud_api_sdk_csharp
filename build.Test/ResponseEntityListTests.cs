...
{
    [TestFixture]
    public class ResponseEntityListTests
    {
        private ResponseEntityList instance;
        ...
        public void Init()
        {
            instance = new ResponseEntityList();
        }
        ...
        /// <summary>
        /// Test an instance of ResponseEntityList
        /// </summary>
        [Test]
        public void ResponseEntityListInstanceTest()
        {
            Assert.IsInstanceOf<ResponseEntityList> (instance, "instance is a ResponseEntityList");
        }
