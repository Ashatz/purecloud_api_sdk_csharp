...
{
    [TestFixture]
    public class ServiceEntityListingTests
    {
        private ServiceEntityListing instance;
        ...
        public void Init()
        {
            instance = new ServiceEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of ServiceEntityListing
        /// </summary>
        [Test]
        public void ServiceEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<ServiceEntityListing> (instance, "instance is a ServiceEntityListing");
        }
