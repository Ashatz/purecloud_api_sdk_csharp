...
{
    [TestFixture]
    public class EncryptionKeyEntityListingTests
    {
        private EncryptionKeyEntityListing instance;
        ...
        public void Init()
        {
            instance = new EncryptionKeyEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of EncryptionKeyEntityListing
        /// </summary>
        [Test]
        public void EncryptionKeyEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<EncryptionKeyEntityListing> (instance, "instance is a EncryptionKeyEntityListing");
        }
