...
{
    [TestFixture]
    public class TemplateEntityListingTests
    {
        private TemplateEntityListing instance;
        ...
        public void Init()
        {
            instance = new TemplateEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of TemplateEntityListing
        /// </summary>
        [Test]
        public void TemplateEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<TemplateEntityListing> (instance, "instance is a TemplateEntityListing");
        }
