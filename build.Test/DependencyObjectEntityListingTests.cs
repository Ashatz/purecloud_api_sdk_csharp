...
{
    [TestFixture]
    public class DependencyObjectEntityListingTests
    {
        private DependencyObjectEntityListing instance;
        ...
        public void Init()
        {
            instance = new DependencyObjectEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of DependencyObjectEntityListing
        /// </summary>
        [Test]
        public void DependencyObjectEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<DependencyObjectEntityListing> (instance, "instance is a DependencyObjectEntityListing");
        }
