...
{
    [TestFixture]
    public class PromptEntityListingTests
    {
        private PromptEntityListing instance;
        ...
        public void Init()
        {
            instance = new PromptEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of PromptEntityListing
        /// </summary>
        [Test]
        public void PromptEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<PromptEntityListing> (instance, "instance is a PromptEntityListing");
        }
