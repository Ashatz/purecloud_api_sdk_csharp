...
{
    [TestFixture]
    public class CertificateAuthorityEntityListingTests
    {
        private CertificateAuthorityEntityListing instance;
        ...
        public void Init()
        {
            instance = new CertificateAuthorityEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of CertificateAuthorityEntityListing
        /// </summary>
        [Test]
        public void CertificateAuthorityEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<CertificateAuthorityEntityListing> (instance, "instance is a CertificateAuthorityEntityListing");
        }
