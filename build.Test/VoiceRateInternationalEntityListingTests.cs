...
{
    [TestFixture]
    public class VoiceRateInternationalEntityListingTests
    {
        private VoiceRateInternationalEntityListing instance;
        ...
        public void Init()
        {
            instance = new VoiceRateInternationalEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of VoiceRateInternationalEntityListing
        /// </summary>
        [Test]
        public void VoiceRateInternationalEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<VoiceRateInternationalEntityListing> (instance, "instance is a VoiceRateInternationalEntityListing");
        }
