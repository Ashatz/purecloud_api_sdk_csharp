...
{
    [TestFixture]
    public class EvaluationFormEntityListingTests
    {
        private EvaluationFormEntityListing instance;
        ...
        public void Init()
        {
            instance = new EvaluationFormEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of EvaluationFormEntityListing
        /// </summary>
        [Test]
        public void EvaluationFormEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<EvaluationFormEntityListing> (instance, "instance is a EvaluationFormEntityListing");
        }
