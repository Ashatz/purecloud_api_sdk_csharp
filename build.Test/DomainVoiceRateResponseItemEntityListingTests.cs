...
{
    [TestFixture]
    public class DomainVoiceRateResponseItemEntityListingTests
    {
        private DomainVoiceRateResponseItemEntityListing instance;
        ...
        public void Init()
        {
            instance = new DomainVoiceRateResponseItemEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of DomainVoiceRateResponseItemEntityListing
        /// </summary>
        [Test]
        public void DomainVoiceRateResponseItemEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<DomainVoiceRateResponseItemEntityListing> (instance, "instance is a DomainVoiceRateResponseItemEntityListing");
        }
