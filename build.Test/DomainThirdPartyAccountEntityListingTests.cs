...
{
    [TestFixture]
    public class DomainThirdPartyAccountEntityListingTests
    {
        private DomainThirdPartyAccountEntityListing instance;
        ...
        public void Init()
        {
            instance = new DomainThirdPartyAccountEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of DomainThirdPartyAccountEntityListing
        /// </summary>
        [Test]
        public void DomainThirdPartyAccountEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<DomainThirdPartyAccountEntityListing> (instance, "instance is a DomainThirdPartyAccountEntityListing");
        }
