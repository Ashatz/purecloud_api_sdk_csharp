...
{
    [TestFixture]
    public class UserEntityListingTests
    {
        private UserEntityListing instance;
        ...
        /// <summary>
        /// Test an instance of UserEntityListing
        /// </summary>
        [Test]
        public void UserEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<UserEntityListing> (instance, "instance is a UserEntityListing");
        }
