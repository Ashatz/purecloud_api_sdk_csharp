...
{
    [TestFixture]
    public class DomainBillingPeriodEntityListingTests
    {
        private DomainBillingPeriodEntityListing instance;
        ...
        public void Init()
        {
            instance = new DomainBillingPeriodEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of DomainBillingPeriodEntityListing
        /// </summary>
        [Test]
        public void DomainBillingPeriodEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<DomainBillingPeriodEntityListing> (instance, "instance is a DomainBillingPeriodEntityListing");
        }
