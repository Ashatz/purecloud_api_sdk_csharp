...
{
    [TestFixture]
    public class PermissionCollectionEntityListingTests
    {
        private PermissionCollectionEntityListing instance;
        ...
        public void Init()
        {
            instance = new PermissionCollectionEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of PermissionCollectionEntityListing
        /// </summary>
        [Test]
        public void PermissionCollectionEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<PermissionCollectionEntityListing> (instance, "instance is a PermissionCollectionEntityListing");
        }
