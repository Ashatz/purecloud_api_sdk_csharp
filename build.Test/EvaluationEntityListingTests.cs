...
{
    [TestFixture]
    public class EvaluationEntityListingTests
    {
        private EvaluationEntityListing instance;
        ...
        public void Init()
        {
            instance = new EvaluationEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of EvaluationEntityListing
        /// </summary>
        [Test]
        public void EvaluationEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<EvaluationEntityListing> (instance, "instance is a EvaluationEntityListing");
        }
