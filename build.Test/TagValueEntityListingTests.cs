...
{
    [TestFixture]
    public class TagValueEntityListingTests
    {
        private TagValueEntityListing instance;
        ...
        public void Init()
        {
            instance = new TagValueEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of TagValueEntityListing
        /// </summary>
        [Test]
        public void TagValueEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<TagValueEntityListing> (instance, "instance is a TagValueEntityListing");
        }
