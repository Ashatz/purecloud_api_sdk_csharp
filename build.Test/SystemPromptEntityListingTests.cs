...
{
    [TestFixture]
    public class SystemPromptEntityListingTests
    {
        private SystemPromptEntityListing instance;
        ...
        public void Init()
        {
            instance = new SystemPromptEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of SystemPromptEntityListing
        /// </summary>
        [Test]
        public void SystemPromptEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<SystemPromptEntityListing> (instance, "instance is a SystemPromptEntityListing");
        }
