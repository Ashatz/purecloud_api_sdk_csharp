...
{
    [TestFixture]
    public class UserSkillEntityListingTests
    {
        private UserSkillEntityListing instance;
        ...
        public void Init()
        {
            instance = new UserSkillEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of UserSkillEntityListing
        /// </summary>
        [Test]
        public void UserSkillEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<UserSkillEntityListing> (instance, "instance is a UserSkillEntityListing");
        }
