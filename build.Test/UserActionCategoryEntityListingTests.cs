...
{
    [TestFixture]
    public class UserActionCategoryEntityListingTests
    {
        private UserActionCategoryEntityListing instance;
        ...
        public void Init()
        {
            instance = new UserActionCategoryEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of UserActionCategoryEntityListing
        /// </summary>
        [Test]
        public void UserActionCategoryEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<UserActionCategoryEntityListing> (instance, "instance is a UserActionCategoryEntityListing");
        }
