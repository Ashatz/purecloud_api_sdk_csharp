...
{
    [TestFixture]
    public class InboundDomainEntityListingTests
    {
        private InboundDomainEntityListing instance;
        ...
        public void Init()
        {
            instance = new InboundDomainEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of InboundDomainEntityListing
        /// </summary>
        [Test]
        public void InboundDomainEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<InboundDomainEntityListing> (instance, "instance is a InboundDomainEntityListing");
        }
