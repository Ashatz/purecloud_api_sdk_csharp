...
{
    [TestFixture]
    public class ConsumedResourcesEntityListingTests
    {
        private ConsumedResourcesEntityListing instance;
        ...
        public void Init()
        {
            instance = new ConsumedResourcesEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of ConsumedResourcesEntityListing
        /// </summary>
        [Test]
        public void ConsumedResourcesEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<ConsumedResourcesEntityListing> (instance, "instance is a ConsumedResourcesEntityListing");
        }
