...
{
    [TestFixture]
    public class AvailableAdditionalServiceListingTests
    {
        private AvailableAdditionalServiceListing instance;
        ...
        public void Init()
        {
            instance = new AvailableAdditionalServiceListing();
        }
        ...
        /// <summary>
        /// Test an instance of AvailableAdditionalServiceListing
        /// </summary>
        [Test]
        public void AvailableAdditionalServiceListingInstanceTest()
        {
            Assert.IsInstanceOf<AvailableAdditionalServiceListing> (instance, "instance is a AvailableAdditionalServiceListing");
        }
