...
{
    [TestFixture]
    public class CommandStatusEntityListingTests
    {
        private CommandStatusEntityListing instance;
        ...
        public void Init()
        {
            instance = new CommandStatusEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of CommandStatusEntityListing
        /// </summary>
        [Test]
        public void CommandStatusEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<CommandStatusEntityListing> (instance, "instance is a CommandStatusEntityListing");
        }
