...
{
    [TestFixture]
    public class SessionEntityListingTests
    {
        private SessionEntityListing instance;
        ...
        public void Init()
        {
            instance = new SessionEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of SessionEntityListing
        /// </summary>
        [Test]
        public void SessionEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<SessionEntityListing> (instance, "instance is a SessionEntityListing");
        }
