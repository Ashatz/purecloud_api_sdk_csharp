...
{
    [TestFixture]
    public class FlowVersionConfigMetaDataEntityListingTests
    {
        private FlowVersionConfigMetaDataEntityListing instance;
        ...
        public void Init()
        {
            instance = new FlowVersionConfigMetaDataEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of FlowVersionConfigMetaDataEntityListing
        /// </summary>
        [Test]
        public void FlowVersionConfigMetaDataEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<FlowVersionConfigMetaDataEntityListing> (instance, "instance is a FlowVersionConfigMetaDataEntityListing");
        }
