...
{
    [TestFixture]
    public class ContactListEntityListingTests
    {
        private ContactListEntityListing instance;
        ...
        public void Init()
        {
            instance = new ContactListEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of ContactListEntityListing
        /// </summary>
        [Test]
        public void ContactListEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<ContactListEntityListing> (instance, "instance is a ContactListEntityListing");
        }
