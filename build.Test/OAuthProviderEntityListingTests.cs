...
{
    [TestFixture]
    public class OAuthProviderEntityListingTests
    {
        private OAuthProviderEntityListing instance;
        ...
        public void Init()
        {
            instance = new OAuthProviderEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of OAuthProviderEntityListing
        /// </summary>
        [Test]
        public void OAuthProviderEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<OAuthProviderEntityListing> (instance, "instance is a OAuthProviderEntityListing");
        }
