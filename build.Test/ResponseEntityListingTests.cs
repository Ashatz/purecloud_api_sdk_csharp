...
{
    [TestFixture]
    public class ResponseEntityListingTests
    {
        private ResponseEntityListing instance;
        ...
        public void Init()
        {
            instance = new ResponseEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of ResponseEntityListing
        /// </summary>
        [Test]
        public void ResponseEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<ResponseEntityListing> (instance, "instance is a ResponseEntityListing");
        }
