...
{
    [TestFixture]
    public class DomainEntityListingTests
    {
        private DomainEntityListing instance;
        ...
        public void Init()
        {
            instance = new DomainEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of DomainEntityListing
        /// </summary>
        [Test]
        public void DomainEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<DomainEntityListing> (instance, "instance is a DomainEntityListing");
        }
