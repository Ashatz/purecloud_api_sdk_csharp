...
{
    [TestFixture]
    public class ReportRunEntryEntityDomainListingTests
    {
        private ReportRunEntryEntityDomainListing instance;
        ...
        public void Init()
        {
            instance = new ReportRunEntryEntityDomainListing();
        }
        ...
        /// <summary>
        /// Test an instance of ReportRunEntryEntityDomainListing
        /// </summary>
        [Test]
        public void ReportRunEntryEntityDomainListingInstanceTest()
        {
            Assert.IsInstanceOf<ReportRunEntryEntityDomainListing> (instance, "instance is a ReportRunEntryEntityDomainListing");
        }
