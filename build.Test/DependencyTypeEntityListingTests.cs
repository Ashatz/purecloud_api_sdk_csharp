...
{
    [TestFixture]
    public class DependencyTypeEntityListingTests
    {
        private DependencyTypeEntityListing instance;
        ...
        public void Init()
        {
            instance = new DependencyTypeEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of DependencyTypeEntityListing
        /// </summary>
        [Test]
        public void DependencyTypeEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<DependencyTypeEntityListing> (instance, "instance is a DependencyTypeEntityListing");
        }
