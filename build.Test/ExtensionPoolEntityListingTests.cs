...
{
    [TestFixture]
    public class ExtensionPoolEntityListingTests
    {
        private ExtensionPoolEntityListing instance;
        ...
        public void Init()
        {
            instance = new ExtensionPoolEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of ExtensionPoolEntityListing
        /// </summary>
        [Test]
        public void ExtensionPoolEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<ExtensionPoolEntityListing> (instance, "instance is a ExtensionPoolEntityListing");
        }
