...
{
    [TestFixture]
    public class SiteEntityListingTests
    {
        private SiteEntityListing instance;
        ...
        public void Init()
        {
            instance = new SiteEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of SiteEntityListing
        /// </summary>
        [Test]
        public void SiteEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<SiteEntityListing> (instance, "instance is a SiteEntityListing");
        }
