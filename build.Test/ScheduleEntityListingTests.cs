...
{
    [TestFixture]
    public class ScheduleEntityListingTests
    {
        private ScheduleEntityListing instance;
        ...
        public void Init()
        {
            instance = new ScheduleEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of ScheduleEntityListing
        /// </summary>
        [Test]
        public void ScheduleEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<ScheduleEntityListing> (instance, "instance is a ScheduleEntityListing");
        }
