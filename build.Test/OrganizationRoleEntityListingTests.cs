...
{
    [TestFixture]
    public class OrganizationRoleEntityListingTests
    {
        private OrganizationRoleEntityListing instance;
        ...
        public void Init()
        {
            instance = new OrganizationRoleEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of OrganizationRoleEntityListing
        /// </summary>
        [Test]
        public void OrganizationRoleEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<OrganizationRoleEntityListing> (instance, "instance is a OrganizationRoleEntityListing");
        }
