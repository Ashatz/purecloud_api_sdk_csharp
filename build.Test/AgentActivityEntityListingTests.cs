...
{
    [TestFixture]
    public class AgentActivityEntityListingTests
    {
        private AgentActivityEntityListing instance;
        ...
        public void Init()
        {
            instance = new AgentActivityEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of AgentActivityEntityListing
        /// </summary>
        [Test]
        public void AgentActivityEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<AgentActivityEntityListing> (instance, "instance is a AgentActivityEntityListing");
        }
