...
{
    [TestFixture]
    public class LogicalInterfaceEntityListingTests
    {
        private LogicalInterfaceEntityListing instance;
        ...
        public void Init()
        {
            instance = new LogicalInterfaceEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of LogicalInterfaceEntityListing
        /// </summary>
        [Test]
        public void LogicalInterfaceEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<LogicalInterfaceEntityListing> (instance, "instance is a LogicalInterfaceEntityListing");
        }
