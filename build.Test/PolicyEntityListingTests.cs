...
{
    [TestFixture]
    public class PolicyEntityListingTests
    {
        private PolicyEntityListing instance;
        ...
        public void Init()
        {
            instance = new PolicyEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of PolicyEntityListing
        /// </summary>
        [Test]
        public void PolicyEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<PolicyEntityListing> (instance, "instance is a PolicyEntityListing");
        }
