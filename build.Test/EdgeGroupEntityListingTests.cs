...
{
    [TestFixture]
    public class EdgeGroupEntityListingTests
    {
        private EdgeGroupEntityListing instance;
        ...
        public void Init()
        {
            instance = new EdgeGroupEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of EdgeGroupEntityListing
        /// </summary>
        [Test]
        public void EdgeGroupEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<EdgeGroupEntityListing> (instance, "instance is a EdgeGroupEntityListing");
        }
