...
{
    [TestFixture]
    public class PhoneMetaBaseEntityListingTests
    {
        private PhoneMetaBaseEntityListing instance;
        ...
        public void Init()
        {
            instance = new PhoneMetaBaseEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of PhoneMetaBaseEntityListing
        /// </summary>
        [Test]
        public void PhoneMetaBaseEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<PhoneMetaBaseEntityListing> (instance, "instance is a PhoneMetaBaseEntityListing");
        }
