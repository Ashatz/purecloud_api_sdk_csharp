...
{
    [TestFixture]
    public class OutboundRouteEntityListingTests
    {
        private OutboundRouteEntityListing instance;
        ...
        public void Init()
        {
            instance = new OutboundRouteEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of OutboundRouteEntityListing
        /// </summary>
        [Test]
        public void OutboundRouteEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<OutboundRouteEntityListing> (instance, "instance is a OutboundRouteEntityListing");
        }
