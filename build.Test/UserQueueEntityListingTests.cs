...
{
    [TestFixture]
    public class UserQueueEntityListingTests
    {
        private UserQueueEntityListing instance;
        ...
        public void Init()
        {
            instance = new UserQueueEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of UserQueueEntityListing
        /// </summary>
        [Test]
        public void UserQueueEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<UserQueueEntityListing> (instance, "instance is a UserQueueEntityListing");
        }
