...
{
    [TestFixture]
    public class DIDEntityListingTests
    {
        private DIDEntityListing instance;
        ...
        /// <summary>
        /// Test an instance of DIDEntityListing
        /// </summary>
        [Test]
        public void DIDEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<DIDEntityListing> (instance, "instance is a DIDEntityListing");
        }
