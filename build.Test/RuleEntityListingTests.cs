...
{
    [TestFixture]
    public class RuleEntityListingTests
    {
        private RuleEntityListing instance;
        ...
        public void Init()
        {
            instance = new RuleEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of RuleEntityListing
        /// </summary>
        [Test]
        public void RuleEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<RuleEntityListing> (instance, "instance is a RuleEntityListing");
        }
