...
{
    [TestFixture]
    public class RuleSetEntityListingTests
    {
        private RuleSetEntityListing instance;
        ...
        public void Init()
        {
            instance = new RuleSetEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of RuleSetEntityListing
        /// </summary>
        [Test]
        public void RuleSetEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<RuleSetEntityListing> (instance, "instance is a RuleSetEntityListing");
        }
