...
{
    [TestFixture]
    public class AddressListingTests
    {
        private AddressListing instance;
        ...
        /// <summary>
        /// Test an instance of AddressListing
        /// </summary>
        [Test]
        public void AddressListingInstanceTest()
        {
            Assert.IsInstanceOf<AddressListing> (instance, "instance is a AddressListing");
        }
