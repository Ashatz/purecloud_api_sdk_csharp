...
{
    [TestFixture]
    public class ReportScheduleEntityListingTests
    {
        private ReportScheduleEntityListing instance;
        ...
        public void Init()
        {
            instance = new ReportScheduleEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of ReportScheduleEntityListing
        /// </summary>
        [Test]
        public void ReportScheduleEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<ReportScheduleEntityListing> (instance, "instance is a ReportScheduleEntityListing");
        }
