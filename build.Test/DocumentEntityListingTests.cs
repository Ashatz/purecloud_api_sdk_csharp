...
{
    [TestFixture]
    public class DocumentEntityListingTests
    {
        private DocumentEntityListing instance;
        ...
        public void Init()
        {
            instance = new DocumentEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of DocumentEntityListing
        /// </summary>
        [Test]
        public void DocumentEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<DocumentEntityListing> (instance, "instance is a DocumentEntityListing");
        }
