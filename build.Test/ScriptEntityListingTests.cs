...
{
    [TestFixture]
    public class ScriptEntityListingTests
    {
        private ScriptEntityListing instance;
        ...
        public void Init()
        {
            instance = new ScriptEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of ScriptEntityListing
        /// </summary>
        [Test]
        public void ScriptEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<ScriptEntityListing> (instance, "instance is a ScriptEntityListing");
        }
