...
{
    [TestFixture]
    public class EdgeLineEntityListingTests
    {
        private EdgeLineEntityListing instance;
        ...
        public void Init()
        {
            instance = new EdgeLineEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of EdgeLineEntityListing
        /// </summary>
        [Test]
        public void EdgeLineEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<EdgeLineEntityListing> (instance, "instance is a EdgeLineEntityListing");
        }
