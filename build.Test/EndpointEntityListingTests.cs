...
{
    [TestFixture]
    public class EndpointEntityListingTests
    {
        private EndpointEntityListing instance;
        ...
        public void Init()
        {
            instance = new EndpointEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of EndpointEntityListing
        /// </summary>
        [Test]
        public void EndpointEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<EndpointEntityListing> (instance, "instance is a EndpointEntityListing");
        }
