...
{
    [TestFixture]
    public class SchemaCategoryEntityListingTests
    {
        private SchemaCategoryEntityListing instance;
        ...
        public void Init()
        {
            instance = new SchemaCategoryEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of SchemaCategoryEntityListing
        /// </summary>
        [Test]
        public void SchemaCategoryEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<SchemaCategoryEntityListing> (instance, "instance is a SchemaCategoryEntityListing");
        }
