...
{
    [TestFixture]
    public class DomainCertificateAuthorityTests
    {
        private DomainCertificateAuthority instance;
        ...
        public void Init()
        {
            instance = new DomainCertificateAuthority();
        }
        ...
        /// <summary>
        /// Test an instance of DomainCertificateAuthority
        /// </summary>
        [Test]
        public void DomainCertificateAuthorityInstanceTest()
        {
            Assert.IsInstanceOf<DomainCertificateAuthority> (instance, "instance is a DomainCertificateAuthority");
        }
