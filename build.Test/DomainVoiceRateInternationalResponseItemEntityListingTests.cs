...
{
    [TestFixture]
    public class DomainVoiceRateInternationalResponseItemEntityListingTests
    {
        private DomainVoiceRateInternationalResponseItemEntityListing instance;
        ...
        public void Init()
        {
            instance = new DomainVoiceRateInternationalResponseItemEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of DomainVoiceRateInternationalResponseItemEntityListing
        /// </summary>
        [Test]
        public void DomainVoiceRateInternationalResponseItemEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<DomainVoiceRateInternationalResponseItemEntityListing> (instance, "instance is a DomainVoiceRateInternationalResponseItemEntityListing");
        }
