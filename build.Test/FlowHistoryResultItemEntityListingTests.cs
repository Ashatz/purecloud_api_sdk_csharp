...
{
    [TestFixture]
    public class FlowHistoryResultItemEntityListingTests
    {
        private FlowHistoryResultItemEntityListing instance;
        ...
        public void Init()
        {
            instance = new FlowHistoryResultItemEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of FlowHistoryResultItemEntityListing
        /// </summary>
        [Test]
        public void FlowHistoryResultItemEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<FlowHistoryResultItemEntityListing> (instance, "instance is a FlowHistoryResultItemEntityListing");
        }
