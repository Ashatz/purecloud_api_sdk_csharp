...
{
    [TestFixture]
    public class DomainLicenseEntityListingTests
    {
        private DomainLicenseEntityListing instance;
        ...
        public void Init()
        {
            instance = new DomainLicenseEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of DomainLicenseEntityListing
        /// </summary>
        [Test]
        public void DomainLicenseEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<DomainLicenseEntityListing> (instance, "instance is a DomainLicenseEntityListing");
        }
