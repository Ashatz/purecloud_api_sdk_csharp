...
{
    [TestFixture]
    public class EvaluatorActivityEntityListingTests
    {
        private EvaluatorActivityEntityListing instance;
        ...
        public void Init()
        {
            instance = new EvaluatorActivityEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of EvaluatorActivityEntityListing
        /// </summary>
        [Test]
        public void EvaluatorActivityEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<EvaluatorActivityEntityListing> (instance, "instance is a EvaluatorActivityEntityListing");
        }
