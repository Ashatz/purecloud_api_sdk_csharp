...
{
    [TestFixture]
    public class WrapupCodeEntityListingTests
    {
        private WrapupCodeEntityListing instance;
        ...
        public void Init()
        {
            instance = new WrapupCodeEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of WrapupCodeEntityListing
        /// </summary>
        [Test]
        public void WrapupCodeEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<WrapupCodeEntityListing> (instance, "instance is a WrapupCodeEntityListing");
        }
