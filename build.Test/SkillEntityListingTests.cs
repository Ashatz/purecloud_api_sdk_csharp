...
{
    [TestFixture]
    public class SkillEntityListingTests
    {
        private SkillEntityListing instance;
        ...
        public void Init()
        {
            instance = new SkillEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of SkillEntityListing
        /// </summary>
        [Test]
        public void SkillEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<SkillEntityListing> (instance, "instance is a SkillEntityListing");
        }
