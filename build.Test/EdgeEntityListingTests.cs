...
{
    [TestFixture]
    public class EdgeEntityListingTests
    {
        private EdgeEntityListing instance;
        ...
        public void Init()
        {
            instance = new EdgeEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of EdgeEntityListing
        /// </summary>
        [Test]
        public void EdgeEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<EdgeEntityListing> (instance, "instance is a EdgeEntityListing");
        }
