...
{
    [TestFixture]
    public class DncListEntityListingTests
    {
        private DncListEntityListing instance;
        ...
        public void Init()
        {
            instance = new DncListEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of DncListEntityListing
        /// </summary>
        [Test]
        public void DncListEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<DncListEntityListing> (instance, "instance is a DncListEntityListing");
        }
