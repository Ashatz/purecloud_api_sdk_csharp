...
{
    [TestFixture]
    public class PhoneEntityListingTests
    {
        private PhoneEntityListing instance;
        ...
        public void Init()
        {
            instance = new PhoneEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of PhoneEntityListing
        /// </summary>
        [Test]
        public void PhoneEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<PhoneEntityListing> (instance, "instance is a PhoneEntityListing");
        }
