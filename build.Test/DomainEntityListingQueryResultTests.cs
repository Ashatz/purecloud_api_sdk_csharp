...
{
    [TestFixture]
    public class DomainEntityListingQueryResultTests
    {
        private DomainEntityListingQueryResult instance;
        ...
        public void Init()
        {
            instance = new DomainEntityListingQueryResult();
        }
        ...
        /// <summary>
        /// Test an instance of DomainEntityListingQueryResult
        /// </summary>
        [Test]
        public void DomainEntityListingQueryResultInstanceTest()
        {
            Assert.IsInstanceOf<DomainEntityListingQueryResult> (instance, "instance is a DomainEntityListingQueryResult");
        }
