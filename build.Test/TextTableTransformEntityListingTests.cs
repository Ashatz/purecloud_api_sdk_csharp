...
{
    [TestFixture]
    public class TextTableTransformEntityListingTests
    {
        private TextTableTransformEntityListing instance;
        ...
        public void Init()
        {
            instance = new TextTableTransformEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of TextTableTransformEntityListing
        /// </summary>
        [Test]
        public void TextTableTransformEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<TextTableTransformEntityListing> (instance, "instance is a TextTableTransformEntityListing");
        }
