...
{
    [TestFixture]
    public class SchemaReferenceEntityListingTests
    {
        private SchemaReferenceEntityListing instance;
        ...
        public void Init()
        {
            instance = new SchemaReferenceEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of SchemaReferenceEntityListing
        /// </summary>
        [Test]
        public void SchemaReferenceEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<SchemaReferenceEntityListing> (instance, "instance is a SchemaReferenceEntityListing");
        }
