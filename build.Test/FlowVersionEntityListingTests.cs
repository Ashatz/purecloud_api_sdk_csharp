...
{
    [TestFixture]
    public class FlowVersionEntityListingTests
    {
        private FlowVersionEntityListing instance;
        ...
        public void Init()
        {
            instance = new FlowVersionEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of FlowVersionEntityListing
        /// </summary>
        [Test]
        public void FlowVersionEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<FlowVersionEntityListing> (instance, "instance is a FlowVersionEntityListing");
        }
