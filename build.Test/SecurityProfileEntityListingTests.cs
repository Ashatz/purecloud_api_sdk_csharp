...
{
    [TestFixture]
    public class SecurityProfileEntityListingTests
    {
        private SecurityProfileEntityListing instance;
        ...
        public void Init()
        {
            instance = new SecurityProfileEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of SecurityProfileEntityListing
        /// </summary>
        [Test]
        public void SecurityProfileEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<SecurityProfileEntityListing> (instance, "instance is a SecurityProfileEntityListing");
        }
