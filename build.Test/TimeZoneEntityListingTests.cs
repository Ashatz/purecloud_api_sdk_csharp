...
{
    [TestFixture]
    public class TimeZoneEntityListingTests
    {
        private TimeZoneEntityListing instance;
        ...
        public void Init()
        {
            instance = new TimeZoneEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of TimeZoneEntityListing
        /// </summary>
        [Test]
        public void TimeZoneEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<TimeZoneEntityListing> (instance, "instance is a TimeZoneEntityListing");
        }
