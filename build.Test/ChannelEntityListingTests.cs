...
{
    [TestFixture]
    public class ChannelEntityListingTests
    {
        private ChannelEntityListing instance;
        ...
        public void Init()
        {
            instance = new ChannelEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of ChannelEntityListing
        /// </summary>
        [Test]
        public void ChannelEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<ChannelEntityListing> (instance, "instance is a ChannelEntityListing");
        }
