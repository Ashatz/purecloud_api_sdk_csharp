...
{
    [TestFixture]
    public class ResponseSetEntityListingTests
    {
        private ResponseSetEntityListing instance;
        ...
        public void Init()
        {
            instance = new ResponseSetEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of ResponseSetEntityListing
        /// </summary>
        [Test]
        public void ResponseSetEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<ResponseSetEntityListing> (instance, "instance is a ResponseSetEntityListing");
        }
