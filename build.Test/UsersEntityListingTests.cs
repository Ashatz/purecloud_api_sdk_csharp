...
{
    [TestFixture]
    public class UsersEntityListingTests
    {
        private UsersEntityListing instance;
        ...
        public void Init()
        {
            instance = new UsersEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of UsersEntityListing
        /// </summary>
        [Test]
        public void UsersEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<UsersEntityListing> (instance, "instance is a UsersEntityListing");
        }
