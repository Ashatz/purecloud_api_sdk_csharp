...
{
    [TestFixture]
    public class CarrierEntityListingTests
    {
        private CarrierEntityListing instance;
        ...
        public void Init()
        {
            instance = new CarrierEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of CarrierEntityListing
        /// </summary>
        [Test]
        public void CarrierEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<CarrierEntityListing> (instance, "instance is a CarrierEntityListing");
        }
