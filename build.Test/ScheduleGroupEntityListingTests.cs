...
{
    [TestFixture]
    public class ScheduleGroupEntityListingTests
    {
        private ScheduleGroupEntityListing instance;
        ...
        public void Init()
        {
            instance = new ScheduleGroupEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of ScheduleGroupEntityListing
        /// </summary>
        [Test]
        public void ScheduleGroupEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<ScheduleGroupEntityListing> (instance, "instance is a ScheduleGroupEntityListing");
        }
