...
{
    [TestFixture]
    public class CalibrationEntityListingTests
    {
        private CalibrationEntityListing instance;
        ...
        public void Init()
        {
            instance = new CalibrationEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of CalibrationEntityListing
        /// </summary>
        [Test]
        public void CalibrationEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<CalibrationEntityListing> (instance, "instance is a CalibrationEntityListing");
        }
