...
{
    [TestFixture]
    public class QueueEntityListingTests
    {
        private QueueEntityListing instance;
        ...
        public void Init()
        {
            instance = new QueueEntityListing();
        }
        ...
        /// <summary>
        /// Test an instance of QueueEntityListing
        /// </summary>
        [Test]
        public void QueueEntityListingInstanceTest()
        {
            Assert.IsInstanceOf<QueueEntityListing> (instance, "instance is a QueueEntityListing");
        }
