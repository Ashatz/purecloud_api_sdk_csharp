...
{
    [TestFixture]
    public class RelationshipListingTests
    {
        private RelationshipListing instance;
        ...
        public void Init()
        {
            instance = new RelationshipListing();
        }
        ...
        /// <summary>
        /// Test an instance of RelationshipListing
        /// </summary>
        [Test]
        public void RelationshipListingInstanceTest()
        {
            Assert.IsInstanceOf<RelationshipListing> (instance, "instance is a RelationshipListing");
        }
