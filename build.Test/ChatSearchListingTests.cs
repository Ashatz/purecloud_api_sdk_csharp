...
{
    [TestFixture]
    public class ChatSearchListingTests
    {
        private ChatSearchListing instance;
        ...
        public void Init()
        {
            instance = new ChatSearchListing();
        }
        ...
        /// <summary>
        /// Test an instance of ChatSearchListing
        /// </summary>
        [Test]
        public void ChatSearchListingInstanceTest()
        {
            Assert.IsInstanceOf<ChatSearchListing> (instance, "instance is a ChatSearchListing");
        }
